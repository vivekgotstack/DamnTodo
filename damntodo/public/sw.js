const CACHE = "damntodo-v9";
const APP_SHELL = ["/", "/manifest.webmanifest", "/sky-viktor.webp", "/motivation-sky.mp4", "/logo-mark.png", "/icon-192.png", "/icon-512.png", "/icon-maskable-512.png"];
