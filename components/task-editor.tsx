              ...
              <>
                ...
                <div className={`alarm-builder ${draft.alarmMode === "strict" ? "is-strict" : ""}`}>
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    {alarmsAvailable && draft.alarmMode !== "none" && <p className="hourly-policy sm:col-span-2"><AlarmClock className="size-4" />Quiet during each session. If it remains unfinished, the first reminder fires when the session ends and repeats every hour.</p>}
                  </div>
